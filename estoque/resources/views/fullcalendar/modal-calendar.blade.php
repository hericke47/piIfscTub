<div class="modal fade" id="modalCalendar" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="titleModal" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form id="formEvent">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea name="description" id="description" cols="29" rows="4"></textarea>
                </div>
            </div>
          </form>
        </div>
